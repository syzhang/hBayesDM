...
from hbayesdm.preprocess_funcs import generalise_preprocess_func

__all__ = ['generalise_gs']


class GeneraliseGs(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            ...
            parameters_desc=OrderedDict([
                ('sigma_a', 'shock generalisation'),
                ('sigma_n', 'no loss generalisation'),
                ('eta', 'Pearce Hall dynamic learning arbitration'),
                ('kappa', 'Pearce Hall dynamic learning weight'),
    ...
    _preprocess_func = generalise_preprocess_func
...
def generalise_gs(
    ...
    """Generalisation avoidance Task - 6 Parameter Model

    Hierarchical Bayesian Modeling of the Generalisation avoidance Task 
    using 6 Parameter Model [Norbury2018]_ with the following parameters:
    "sigma_a" (shock generalisation), "sigma_n" (no loss generalisation), "eta" (Pearce Hall dynamic learning arbitration), "kappa" (Pearce Hall dynamic learning weight), "beta" (softmax temperature), "bias" (softmax bias).

    

    
    .. [Norbury2018] Norbury, Agnes, Trevor W Robbins, and Ben Seymour. (2018). ‘Value Generalization in Human Avoidance Learning’. Edited by Daeyeol Lee. ELife 7 (May): e34779. https://doi.org/10.7554/eLife.34779.

    .. codeauthor:: Suyi Zhang <suyizhang52@gmail.com>
    ...
    **tab-delimited** text file, whose rows represent trial-by-trial observations
    ...
    For the Generalisation avoidance Task, there should be 4 columns of data
    with the labels "subjID", "cue", "choice", "outcome". It is not necessary for the columns to be
    ...
    - "cue": Interger value representing the visual cue presented on the given trial, 1-7
    - "choice": Integer value representing the avoidance choice on the given trial, 1 - avoided, 0 - not avoided
    - "outcome": Floating point value representing the shock/loss outcome on the given trial (-1 or other losses).
    ...
    data
        ...
        Data columns should be labeled as: "subjID", "cue", "choice", "outcome".
    niter
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('generalise_gs').
    ...
    .. code:: python
        ...
        output = generalise_gs(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
